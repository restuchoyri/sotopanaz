        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content" style="padding: 20px">
            ...
            <div class="chart tab-pane active" id="tab1">
              ...
              <h4 class="text-center">Realisasi Pengeluaran/Belanja UPTD KST SOLO TECHNOPARK Tahun 2023 Per <b>Divisi</b> </h4>
              ...
              <h4 class="text-center">Progress Realisasi Pengeluaran/Belanja UPTD KST SOLO TECHNOPARK Tahun 2023 Per <b>Bulan</b></h4>
              <?php 
