...
<div class="col-lg-3 col-xs-6">
  <div class="small-box bg-green">
    <div class="inner">
      <?php 
      $tanggal = date('Y-m-d');
      $pendidikan = mysqli_query($koneksi,"SELECT count(Id_pendidikan) as pendidikan_S1 FROM riwayat_pendidikan LEFT JOIN tingkat_pendidikan ON riwayat_pendidikan.Id_tingkat_pendidikan=tingkat_pendidikan.Id_tingkat_pendidikan WHERE riwayat_pendidikan.Id_tingkat_pendidikan = '6'");
      $p = mysqli_fetch_assoc($pendidikan);
      ?>
      <h4 style="font-weight: bolder">
        <?php 
...
<div class="col-lg-3 col-xs-6">
  <div class="small-box bg-green">
    <div class="inner">
      <?php 
      $tanggal = date('Y-m-d');
      $pendidikan = mysqli_query($koneksi,"SELECT count(Id_pendidikan) as pendidikan_S1 FROM riwayat_pendidikan LEFT JOIN tingkat_pendidikan ON riwayat_pendidikan.Id_tingkat_pendidikan=tingkat_pendidikan.Id_tingkat_pendidikan WHERE riwayat_pendidikan.Id_tingkat_pendidikan = '7'");
      $p = mysqli_fetch_assoc($pendidikan);
      ?>
      <h4 style="font-weight: bolder">
        <?php 
...
<div class="col-lg-3 col-xs-6">
  <div class="small-box bg-green">
    <div class="inner">
      <?php 
      $tanggal = date('Y-m-d');
      $pendidikan = mysqli_query($koneksi,"SELECT count(Id_pendidikan) as pendidikan_S1 FROM riwayat_pendidikan LEFT JOIN tingkat_pendidikan ON riwayat_pendidikan.Id_tingkat_pendidikan=tingkat_pendidikan.Id_tingkat_pendidikan WHERE riwayat_pendidikan.Id_tingkat_pendidikan = '8'");
      $p = mysqli_fetch_assoc($pendidikan);
      ?>
      <h4 style="font-weight: bolder">
        <?php 
...
<div class="col-lg-3 col-xs-6">
  <div class="small-box bg-red">
    <div class="inner">
    <?php 
      $karyawan = mysqli_query($koneksi,"SELECT COUNT(Id_karyawan) AS total_karyawan FROM karyawan");
      $p = mysqli_fetch_assoc($karyawan);
      ?>
      
      <h4 style="font-weight: bolder">
      <?php 
       echo $p['total_karyawan']
        ?>
      </h4>
      <p>Total Seluruh Karyawan</p>
    </div>
    <div class="icon">
      <i class="ion ion-stats-bars"></i>
    </div>
