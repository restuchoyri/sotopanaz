            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  include '../koneksi.php';
                  $no=1;
                    $data = mysqli_query($koneksi,"SELECT karyawan.*, jabatan.Nama_jabatan, unit_kerja.Nama_unit_kerja FROM karyawan LEFT JOIN jabatan ON karyawan.Id_jabatan=jabatan.Id_jabatan LEFT JOIN unit_kerja ON karyawan.Id_unit_kerja=unit_kerja.Id_unit_kerja ORDER BY karyawan.Id_karyawan DESC ");
