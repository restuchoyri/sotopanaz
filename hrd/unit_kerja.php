      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-header">
            ...
            <div class="btn-group pull-right">            
              ...
              <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal">
                <i class="fa fa-plus"></i> &nbsp Tambah Unit Kerja
              </button>
          ...
          <div class="box-body">
            ...
            <!-- Modal -->
            <form action="unit_kerja_proses.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="nama" required="required" class="form-control" placeholder="Masukkan Nama Unit..">
                      </div>
                    </div>
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td>    
                        ...
                        <form action="unit_kerja_update.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal fade" id="hapus_unit_<?php echo $d['Id_unit_kerja'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                <a href="unit_kerja_hapus.php?id=<?php echo $d['Id_unit_kerja'] ?>" class="btn btn-primary">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div>
