...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      SKOR PENILAIAN
      <small>Skor Penilaian Karyawan</small>
    </h1>
    <ol class="breadcrumb">
      ...
      <section class="col-lg-12">
        <div class="box box-info">
          <div class="box-header">
            <table class="table">
              <tr>
                <td class="text-left"><h3 class="box-title">Karyawan yang Dinilai</h3></td>
                <th class="text-right">SKOR</th>
                <td class="text-center text-bold text-white bg-primary"><?php echo $mean; ?></td>
              </tr>
              </table>
          </div>
          <div class="box-body">
